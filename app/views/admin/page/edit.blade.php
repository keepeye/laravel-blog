...
<div class="row">
    ...
    {{ Form::open(array('route'=>['admin.page.update',$page->id],'method'=>'put','role'=>'form')) }}
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="form-group">
                    <label for="title">标题</label>
                    <input class="form-control" id="title" name="data[title]" value="{{$page->title}}" type="text" placeholder="输入标题.." required/>
                </div>

                <div class="form-group">
                    <label>正文</label>
                    <span class="help-block">请用markdown语法书写正文，建议用专业编辑器写完复制到这里</span>
                    <textarea class="form-control" id="page_content" name="data[content_md]"  rows="10">{{$page->content_md}}</textarea>
                </div>
